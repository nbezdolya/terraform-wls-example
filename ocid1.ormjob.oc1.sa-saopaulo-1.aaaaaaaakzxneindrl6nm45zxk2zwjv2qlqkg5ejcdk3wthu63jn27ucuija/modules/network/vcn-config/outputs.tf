...
output "service_gateway_route_table_id" {
  ...
  value       = element(coalescelist(oci_core_route_table.wls-service-gateway-route-table-newvcn.*.id, oci_core_route_table.wls-service-gateway-route-table-existingvcn.*.id, list("")), 0)
}
